...
/**
 * @program: pdf-convert
 * @description: 替换图片中的二维码
 * @author: xf
 * @create: 2023-01-04 17:06
 **/
public class QRCodeTools {

    public static void main(String[] args) {

//        deEncodeByPath("G:\\图文文档集\\海报-整合版.png", "G:\\图文文档集\\shorturl\\宝应站.png");
    }
     ...
     */
    public static void deEncodeByPath(String filePath, String newPath, String imgName) {
...
//            float point2Y = resultPoint[1].getY();
            ...
            float point1X = 395.0f;
            float point1Y = 1590.5f;
            float point2X = 394.0f;
            float point2Y = 1244.0f;
            ...
            ImageIO.write(readImage, "png", new File("G:\\图文文档集\\站点海报\\" + imgName + ".png"));
//            ImageIO.write(readImage, "png", new File("G:\\图文文档集\\海报--"+imgName+".png"));
            // 打印替换后的图片
